    ...
    public function situacaoStatus()
{
    ...
    public function motivoinativos()
    {
...
{
    return $this->hasOne(\App\UserDocumento::class, 'user_id')->where('tipo', 'frente');
}

public function documentoVerso()
{
    return $this->hasOne(\App\UserDocumento::class, 'user_id')->where('tipo', 'verso');
}
/**
