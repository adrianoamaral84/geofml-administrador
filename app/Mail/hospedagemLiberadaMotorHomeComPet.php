...
class hospedagemLiberadaMotorHomeComPet extends Mailable
{
    ...
    {
        //dd($this->hospede);
        $mensagem = \App\GerenciarEmails::where('id', 8)->first();
        ...
        return $this->markdown('mail.hospedagemLiberadaMotorHomeComPet')->with([
