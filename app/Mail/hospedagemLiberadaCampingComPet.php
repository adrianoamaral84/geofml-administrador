...
class hospedagemLiberadaCampingComPet extends Mailable
{
    ...
    {
        //dd($this->hospede);
        $mensagem = \App\GerenciarEmails::where('id', 7)->first();
        ...
        return $this->markdown('mail.hospedagemLiberadaCampingComPet')->with([
