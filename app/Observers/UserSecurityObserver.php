...
class UserSecurityObserver
{
    ...
    public function saving($user)
    {
        ...
        // Fluxos antigos criavam/resetavam a senha usando o CPF. Nunca grave esse valor.
        if ($cpf && $this->hashMatches($cpf, $passwordHash)) {
            ...
            // A senha temporaria nao e exibida nem conhecida pelo administrador.
            // O usuario recebera um link oficial para definir a propria senha.
            $user->password = Hash::make(Str::random(64));

            // Um reset administrativo tambem reativa uma conta bloqueada por inatividade.
        ...
        // Evita sobrescritas acidentais por campos de senha ausentes/não validados.
        // Isso corrige, por exemplo, fluxos antigos que faziam Hash::make($request->password)
        // sem validar ou sequer exigir o campo password.
