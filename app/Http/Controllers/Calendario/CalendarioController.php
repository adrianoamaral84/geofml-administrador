...
class CalendarioController extends Controller
{
    ...
    public function calendarioUnidade($unidade, $data_ini, $data_final){
        ...
        //dd($unidade);
        $mes = new DateTime($data_ini);
        $mes = $mes->format('Y-m-d');
        

        $date = date("d/m/Y");
        $dateMais2 = strtotime(date("d/m/Y", strtotime($date)) . "+2 months");
        $dateMenos2 = strtotime(date("d/m/Y", strtotime($date)) . "-2 months");
        
        $dateMais2 = date("Y-m-d",$dateMais2);
        $dateMenos2 = date("Y-m-d",$dateMenos2);
