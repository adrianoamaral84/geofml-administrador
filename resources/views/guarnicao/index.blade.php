...
<article class="items-list-page">
    <div class="title-search-block">
        <div class="title-block">
            <div class="row">
                <div class="col-md-6">
                    <h3 class="title"> Lista de Guarnições <a href="{{Route('showFormCadastra')}}" class="btn btn-primary btn-sm rounded-s"> Add Guarnição </a></h3> 
                </div>
            </div>
        </div>
        <div class="items-search">
            <form class="form-inline" method="POST" action="{{Route('guarnicao.index')}}">
            @csrf       
    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                ...
                <a href="{{ route('guarnicao.edit', ['id' => Crypt::encrypt($item->id)]) }}" class="btn btn-info btn-sm">
                                        ...
                                        <form action="" id="deletearea" method="get">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    {{ csrf_field() }}  
                                                    {{ method_field('DELETE') }}
                                                    <p>Tem certeza que deseja deletar essa Guarnição ?</p>
                                                </div>
...
<script type="text/javascript">
     ...
     {
         var id = id;
         var url = '{{ route("guarnicao.destroy", ":id") }}';
