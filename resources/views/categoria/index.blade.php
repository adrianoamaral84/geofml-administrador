...
<article class="items-list-page">
    <div class="title-search-block">
        <div class="title-block">
            <div class="row">
                <div class="col-md-6">
                    <h3 class="title"> Lista de Categorias <a href="{{ route('categoria.create.show') }}" class="btn btn-primary btn-sm rounded-s"> Add </a></h3> 
                </div>
            </div>
        </div>
        <div class="items-search">
            <form class="form-inline" method="POST" action="{{ route('categoria.index') }}">
            @csrf       
    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                ...
                <a href="{{ route('categoria.edit', ['id' => Crypt::encrypt($item->id)]) }}" title="Editar Área" class="btn btn-info btn-sm">
