...
<article class="items-list-page">
    <div class="title-search-block">
        <div class="title-block">
            <div class="row">
                <div class="col-md-6">
                    <h3 class="title"> Dados Gerais  <a href="{{ route('dadosgerais.create')}}" class="btn btn-primary btn-sm rounded-s"> Add </a></h3> 
                </div>
            </div>
        </div>
                                ...
                                <table class="table table-striped table-bordered table-hover flip-content">
                                    ...
                                    <tbody>                                        
                                            ...
                                            <tr>
                                               ...
                                               <td style="text-align: center">{!! $item->cabecalho !!}</td>
                                                <td>{{$item->nome_secao}}</td>
                                                <td>{{$item->assinatura}}</td>
                                                <td style="text-align: center;">
                                                    <h6>
                                                    

                <a href="{{ route('dadosgerais.edit', ['id' => Crypt::encrypt($item->id)]) }}" class="btn btn-info btn-sm">
...
<script type="text/javascript">
     ...
     {
         var id = id;
         var url = '{{ route("dadosgerais.delete", ":id") }}';
