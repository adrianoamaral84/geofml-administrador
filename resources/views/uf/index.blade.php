...
<article class="items-list-page">
    <div class="title-search-block">
        <div class="title-block">
            <div class="row">
                <div class="col-md-6">
                    <h3 class="title"> Lista de Estados  <a href="{{Route('uf.create')}}" class="btn btn-primary btn-sm rounded-s"> Add Estado </a></h3> 
                </div>
            </div>
        </div>
        <div class="items-search">
           
        <form method="GET" action="{{ route('indexuf') }}" class="form-inline mb-3">
    <div class="input-group input-group-sm">
        <input type="text" name="search" class="form-control" placeholder="Buscar Estado ou Sigla..." value="{{ $search }}">
        <div class="input-group-append">
            <button type="submit" class="btn btn-primary btn-sm">Pesquisar</button>
            @if($search)
                <a href="{{ route('indexuf') }}" class="btn btn-secondary btn-sm">Limpar</a>
            @endif
        </div>
    </div>
</form>
