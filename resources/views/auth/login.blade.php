...
<form id="login-form" action="{{ route('login') }}" method="POST">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control underlined @error('cpf') is-invalid @enderror" value="{{ old('cpf') }}" name="cpf" id="cpf" required maxlength="11" 
