...
<article class="items-list-page">
    <div class="title-search-block">
        <div class="title-block">
            <div class="row">
                <div class="col-md-6">
                    <h3 class="title"> Classes Habitacionais  <a href="{{ route('classehabitacao.create')}}" class="btn btn-primary btn-sm rounded-s"> Add </a></h3> 
                </div>
            </div>
        </div>
    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                ...
                <a href="{{ route('classehabitacao.edit', ['id' => Crypt::encrypt($item->id)]) }}" class="btn btn-info btn-sm">
...
<script type="text/javascript">
     ...
     {
         var id = id;
         var url = '{{ route("classehabitacao.delete", ":id") }}';
