...
function trocaCalendarios(Id, cidadeFieldName){
    ...
    if(Id) {
        $.ajax({
            ...
            success:function(data) {
                ...
                if(count > 0) {
                   ...
                   for(var i = 0; i < count; i++) {
                   	...
                   	<?php
                   	$a[] = "data[i].data_inicio, data[i].data_termino";
                   	//print_r($a);
                   	?>
                   	alert('e');
            ...
            error: function(XMLHttpRequest, textStatus, errorThrown){
                alert("Erro ao carregar Calendario. Status: " + textStatus); alert("Error: " + errorThrown);
            }
        });
    }else{
