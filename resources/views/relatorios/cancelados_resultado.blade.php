...
<article class="items-list-page">
    <div class="title-search-block">
        <div class="title-block">
            <div class="row">
                <div class="col-md-6">
                    <h3 class="title">Relatório de Cancelados Pagos Mensal {{$mes}}/{{$ano}}</h3> 
        ...
        <form method="POST" action="{{ url('admin/relatorio/cancelados/view') }}" class="form-inline mb-3">
    @csrf
                                ...
                                <table class="table table-striped table-bordered table-hover flip-content" id="tabela">
                                    <thead class="flip-header">
                                        <tr>
                                            ...
                                            <th width="8%" style="text-align: center;">Data Início</th>
                                            <th width="8%" style="text-align: center;">Data Final</th>
                                    ...
                                    @if(isset($hospedagem))
                                            ...
                                            @else
                                             @foreach ($hospedagem as $item) 
                                            <tr>

                                                <td style="text-align: center;"> {{$item->user->posto->sigla}} </td>
                                                <td> 
                                                       
                                                        <a href="{{ route('hospedagem.verdados', ['id' => Crypt::encrypt($item->id)]) }}" title="Ver Dados">{{$item->user->name}}</a>
...
$(document).ready(function() {
   ...
   buttons: [
            ...
            {
                extend: 'excelHtml5',              
                title: 'GEOFML - Relatório de Cancelados Mensal',
                footer: true,
            },
            {
                extend: 'pdfHtml5',
