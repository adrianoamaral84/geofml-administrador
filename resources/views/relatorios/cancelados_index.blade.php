...
<article class="items-list-page">
    <div class="title-search-block">
        <div class="title-block">
            <div class="row">
                <div class="col-md-6">
                    <h3 class="title"> Relatório de Cancelados Pagos </h3> 
                    <small>Relatório de cancelados pagos!</small>
                </div>
            </div>
        </div>
        ...
        <div class="row sameheight-container">
            <div class="col-12">
                <div class="card card-block sameheight-item">
                     ...
                     <form id="profile-form" action="{{ route('cancelados.view')}}" method="POST" enctype="multipart/form-data">
                    @csrf
