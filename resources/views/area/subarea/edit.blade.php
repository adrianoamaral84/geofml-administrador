...
<article class="items-list-page">
    <div class="title-search-block">
        <div class="title-block">
            <div class="row">
                <div class="col-md-6">
                    <h3 class="title"> Editar SubArea </h3>
                </div>
            </div>
        </div>
                    ...
                    <div class="card-block">
                        <section class="example">
                            <div class="table-flip-scroll">
                                <form id="password-form" action="{{Route('subarea.update')}}" method="POST">
                                    @csrf
                                ...
                                <input type="text" name="nome" id="nome" class="form-control boxed @error('nome') is-invalid @enderror" value="{{$consulta->descricao}}" maxlength="100" onpaste="return false;" autofocus>
                                            ...
                                            <input type="hidden" name="id_area" id="id_area" class="form-control boxed" value="{{$consulta->area_id}}">
                                            @error('nome')
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-10 col-sm-offset-2">
                                            <button type="submit" class="btn btn-primary btn-sm rounded-s"><i class="fas fa-check-circle fa-sm"></i>  Atualizar </button>
                                             <a href="" class="btn btn-danger btn-sm rounded-s"><i class="fas fa-window-close fa-sm"></i>  Cancelar </a>
                                        </div>
                                    </div>
                                </form>
