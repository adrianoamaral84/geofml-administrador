        ...
        <div class="title-block">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <small>Lista de Subtenente, Sargento e SC NM </small> 
                </div>
            </div>
        </div>
                    ...
                    <div class="card-block">
                        <section class="example">
                            <div class="table-flip-scroll">
                                <h3 class="title"> ST / SGT </h3>
                                <hr>
                                
                                <table class="table table-striped table-bordered table-hover flip-content" id="tabela1">
                                    ...
                                    <tbody>
                                            ...
                                            @foreach ($StSgtAtivaCMS as $item)     
                                            <tr style="background-color: #CCFF94;">
                                               <td> {{$item->sigla}}  </td>
                                                <td> 
                                            ...
                                            @foreach ($StSgtAtivaNOCMS as $item)     
                                            <tr>
                                               <td> {{$item->sigla}}  </td>
                                                <td> 
                                            ...
                                            @foreach ($StSgtAtivaCMSPET as $item)     
                                            ...
                                            @foreach ($StSgtAtivaNOCMSPET as $item)     
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-block">
                        <section class="example">
                            <div class="table-flip-scroll">
                                <h3 class="title"> ST / SGT R1 PTTC </h3>
                                 <hr>
                                ...
                                <table class="table table-striped table-bordered table-hover flip-content" id="tabela">
                                    ...
                                    <tbody> 
                                            ...
                                            @foreach ($StSgtReservaPttcCMS as $item)     
                                            <tr style="background-color: #CCFF94;">
                                               <td> {{$item->sigla}}  </td>
                                                <td> 
                                            ...
                                            @foreach ($StSgtReservaPttcNOCMS as $item)     
                                            <tr>
                                               <td> {{$item->sigla}}  </td>
                                                <td> 
                                            ...
                                            @foreach ($StSgtReservaPttcCMSPET as $item)     
                                            <tr style="background-color: #9b0000; color: #fff;">
                                               <td> {{$item->sigla}}  </td>
                                                <td> 
                                            ...
                                            @foreach ($StSgtReservaPttcNOCMSPET as $item)     
                                            <tr style="background-color: #e60000; color: #fff;">
                                               <td> {{$item->sigla}}  </td>
                                                <td> 
                            ...
                            <div class="table-flip-scroll">
                                ...
                                <table class="table table-striped table-bordered table-hover flip-content" id="tabela">
                                    ...
                                    <tbody>                                        
                                            ...
                                            @foreach ($StSgtReservaNOCMSR1 as $item)     
                                             <tr>
                                               <td> {{$item->sigla}}  </td>
                                                <td> 
                                            ...
                                            @foreach ($StSgtReservaPETCMS as $item)     
                                             <tr style="background-color: #9b0000; color: #fff;">
                                               <td> {{$item->sigla}}  </td>
                                                <td> 

                                                <a style="color: #fff;" style="color: #000;" href="{{ route('hospedagem.verdados', ['id' => Crypt::encrypt($item->id)]) }}" title="Ver Dados">         
                                                {{$item->name}}
                                                </a>
                                            ...
                                            @foreach ($StSgtReservaPETNOCMS as $item)     
                                             <tr style="background-color: #e60000; color: #fff;">
                                               <td> {{$item->sigla}}  </td>
                                                <td> 
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-block">
                        <section class="example">
                            <div class="table-flip-scroll">
                                <h3 class="title"> Servidor Civil NM </h3>
                                 <hr>
                                ...
                                <table class="table table-striped table-bordered table-hover flip-content" id="tabela">
                                    ...
                                    <tbody>                                        
                                            @foreach ($ServidorCivilNM as $item)     
                                            <tr>
                                               <td> {{$item->sigla}}  </td>
                                                <td> 
                                            ...
                                            @foreach ($ServidorCivilNMPET as $item)     
                                            <tr style="background-color: #9b0000; color: #fff;">
                                               <td> {{$item->sigla}}  </td>
                                                <td> 
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-block">
                        <section class="example">
                            <div class="table-flip-scroll">
                                <h3 class="title"> Pensionista de ST / SGT </h3>
                                 <hr>
                                ...
                                <table class="table table-striped table-bordered table-hover flip-content" id="tabela">
                                    ...
                                    <tbody>                                        
                                            @foreach ($PensionistaSTSgt as $item)     
                                            <tr style="background-color: #CCFF94;">
                                               <td> {{$item->sigla}}  </td>
                                                <td> 
                                            ...
                                            @foreach ($PensionistaSTSgtNOMCS as $item)     
                                            ...
                                            @foreach ($PensionistaSTSgtPET as $item)     
                                            <tr style="background-color: #9b0000; color: #fff;">
                                               <td> {{$item->sigla}}  </td>
                                                <td> 
                                            ...
                                            @foreach ($PensionistaSTSgtPETNOMCS as $item)     
                                            <tr style="background-color: #e60000; color: #fff;">
                                               <td> {{$item->sigla}}  </td>
                                                <td> 
                            ...
                            <div class="table-flip-scroll">
                                ...
                                <table class="table table-striped table-bordered table-hover flip-content" id="tabela">
                                    ...
                                    <tbody> 
                                            ...
                                            @foreach ($StSgtAtivaCMSFORCAAEREA as $item)     
                                            ...
                                            @foreach ($StSgtReservaPttcFORCAAEREA as $item)     
                                            ...
                                            @endforeach
                                             ...
                                             @foreach ($StSgtReservaFORCAAEREAR1 as $item)     
                                            ...
                                            @foreach ($StSgtAtivaCMSFORCAAEREAPET as $item)     
                                            <tr style="background-color: #9b0000; color: #fff;">
                                            ...
                                            @endforeach
                                             ...
                                             @foreach ($StSgtReservaPttcFORCAAEREAPET as $item)     
                                            <tr style="background-color: #9b0000; color: #fff;">
                                               <td> {{$item->sigla}}  </td>
                                                <td> 
                                            ...
                                            @foreach ($StSgtReservaForcaPET as $item)     
                                            <tr style="background-color: #9b0000; color: #fff;">
                                               <td> {{$item->sigla}}  </td>
                                                <td> 
                                            ...
                                            @foreach ($StSgtAtivaNOCMSMARINHAPET as $item)     
                                            <tr style="background-color: #e60000; color: #fff;">
                                               <td> {{$item->sigla}}  </td>
                                                <td> 
                            ...
                            <div class="table-flip-scroll">
                                ...
                                <table class="table table-striped table-bordered table-hover flip-content" id="tabela">
                                    ...
                                    <tbody> 
                                            ...
                                            @foreach ($StSgtAtivaMarinha as $item)     
                                           <tr style="background-color: #424242; color: #fff;">
                                            ...
                                            @foreach ($StSgtReservaPttcMARINHA as $item)     
                                            <tr style="background-color: #A4A4A4; color: #000">
                                               <td> {{$item->sigla}}  </td>
                                                <td style="color: #000"> 
                                                ...
                                                <td style="text-align: center; color: #000">{{$item->descricao}}</td>
                                                <td style="text-align: center;">
                                                {{ \Carbon\Carbon::parse($item->data_inicio)->format('d/m/Y') }}
                                                </td>
                                                <td style="text-align: center;">
                                            ...
                                            @foreach ($StSgtReservaMARINHAR1 as $item)     
                                            <tr style="background-color: #FAFAFA; color: #000;">
                                               <td style="color: #000;"> {{$item->sigla}}  </td>
                                                <td > 
                                                <a style="color: #000;" href="{{ route('hospedagem.verdados', ['id' => Crypt::encrypt($item->id)]) }}" title="Ver Dados">         
                                                {{$item->name}}
                                                </a>
                                            ...
                                            @foreach ($StSgtAtivaMarinhaPET as $item)     
                                            <tr style="background-color: #9b0000; color: #fff;">
                                               <td> {{$item->sigla}}  </td>
                                                <td> 
                                            ...
                                            @foreach ($StSgtReservaPttcMARINHAPET as $item)     
                                            <tr style="background-color: #9b0000; color: #fff;">
                                               <td> {{$item->sigla}}  </td>
                                                <td> 
                                            ...
                                            @endforeach
                                             ...
                                             @foreach ($StSgtReservaMarinhaPET as $item)     
                                            <tr style="background-color: #9b0000; color: #fff;">
                                               <td> {{$item->sigla}}  </td>
                                                <td> 
