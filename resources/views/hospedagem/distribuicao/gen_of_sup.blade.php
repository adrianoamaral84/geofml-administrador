        ...
        <div class="title-block">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <small>Lista de Oficiais Superiores </small> 
                </div>
            </div>
        </div>
                    ...
                    <div class="card-block">
                        <section class="example">
                            <div class="table-flip-scroll">
                               <h3 class="title"> Oficiais Superiores </h3>
                                <hr> 
                                ...
                                <table class="table table-striped table-bordered table-hover flip-content" id="tabela">
                                    ...
                                    <tbody>                                        
                                            ...
                                            @endforeach
                                            @foreach ($ofSupAtivaNOCMS as $item) 
                                            ...
                                            @foreach ($ofSupAtivaCMSPET as $item)     
                                            ...
                                            @foreach ($ofSupAtivaNOCMSPET as $item)     
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-block">
                        <section class="example">
                            <div class="table-flip-scroll">
                                <h3 class="title"> Oficiais Superiores R1 PTTC </h3>
                                 <hr>
                                ...
                                <table class="table table-striped table-bordered table-hover flip-content" id="tabela">
                                    ...
                                    <tbody>                                        
                                            @foreach ($ofSupReservaPttcCMS as $item)     
                                            <tr style="background-color: #CCFF94;">
                                               <td> {{$item->sigla}}  </td>
                                                <td> 
                                            ...
                                            @endforeach
                                             ...
                                             @foreach ($ofSupReservaPttcNOCMS as $item)     
                                            <tr>
                                               <td> {{$item->sigla}}  </td>
                                                <td> 
                                            ...
                                            @foreach ($ofSupReservaPttcCMSPET as $item)     
                                            <tr style="background-color: #9b0000; color: #fff;">
                                               <td> {{$item->sigla}}  </td>
                                                <td> 
                                            ...
                                            @foreach ($ofSupReservaPttcNOCMSPET as $item)     
                                            <tr style="background-color: #e60000; color: #fff;">
                                               <td> {{$item->sigla}}  </td>
                                                <td> 
                                            ...
                                            @foreach ($ofSupReservaPttcMarinhaPET as $item)     
                                            <tr style="background-color: #9b0000; color: #fff;">
                                               <td> {{$item->sigla}}  </td>
                                                <td> 
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-block">
                        <section class="example">
                            <div class="table-flip-scroll">
                                <h3 class="title"> Oficiais Superiores R1 </h3>
                                 <hr>
                                ...
                                <table class="table table-striped table-bordered table-hover flip-content" id="tabela">
                                    ...
                                    <tbody>                                        
                                            ...
                                            @foreach ($ofSupReservaNOCMSR1 as $item)     
                                            <tr>
                                               <td> {{$item->sigla}}  </td>
                                                <td> 
                                            ...
                                            @foreach ($ofSupReservaPET as $item)     
                                            <tr style="background-color: #9b0000; color: #fff;">
                                               <td> {{$item->sigla}}  </td>
                                                <td> 
                                            ...
                                            @foreach ($ofSupReservaPETNOCMS as $item)     
                                            <tr style="background-color: #e60000; color: #fff;">
                                               <td> {{$item->sigla}}  </td>
                                                <td> 
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-block">
                        <section class="example">
                            <div class="table-flip-scroll">
                               <h3 class="title"> Pensionistas de Oficiais Superiores </h3>
                                <hr> 
                                ...
                                <table class="table table-striped table-bordered table-hover flip-content" id="tabela">
                                    ...
                                    <tbody>                                        
                                            @foreach ($ofSupPensionista as $item)     
                                           <tr style="background-color: #CCFF94; color: #000">
                                            ...
                                            @endforeach
                                           @foreach ($ofSupPensionistaNOCMS as $item)     
                                           <tr style="background-color: #dee2e6; color: #000">
                                            ...
                                            @foreach ($ofSupPensionistaPET as $item)     
                                            <tr style="background-color: #9b0000; color: #fff;">
                                               <td> {{$item->sigla}}  </td>
                                                <td> 
                                            ...
                                            @foreach ($ofSupPensionistaPETNOCMS as $item)     
                                            <tr style="background-color: #e60000; color: #fff;">
                                               <td> {{$item->sigla}}  </td>
                                                <td> 
                        ...
                        <section class="example">
                            <div class="table-flip-scroll">
                                ...
                                <table class="table table-striped table-bordered table-hover flip-content" id="tabela">
                                    ...
                                    @foreach ($ofSupAtivaForcaAerea as $item)     
                                           <tr style="background-color: #0B2161; color: #fff">
                                            ...
                                            @endforeach
                                             ...
                                             @foreach ($ofSupReservaPttcForcaAerea as $item)     
                                           <tr style="background-color: #2E64FE; color: #fff">
                                            ...
                                            @endforeach
                                             ...
                                             @foreach ($ofSupReservaFORCAR1 as $item)     
                                            <tr style="background-color: #81BEF7; color: #000;">
                                               <td> {{$item->sigla}}  </td>
                                                <td> 
                                                <a style="color: #000" href="{{ route('hospedagem.verdados', ['id' => Crypt::encrypt($item->id)]) }}" title="Ver Dados">         
                                                {{$item->name}}
                                            ...
                                            @foreach ($ofSupAtivaForcaAereaPET as $item)     
                                            <tr style="background-color: #9b0000; color: #fff;">
                                               <td> {{$item->sigla}}  </td>
                                                <td> 
                                            ...
                                            @endforeach
                                             ...
                                             @foreach ($ofSupReservaPttcForcaAereaPET as $item)     
                                            <tr style="background-color: #9b0000; color: #fff;">
                                               <td> {{$item->sigla}} PTTC </td>
                                                <td> 
                                            ...
                                            @endforeach
                                            @foreach ($ofSupReservaForcaAereaPET as $item)     
                                            <tr style="background-color: #9b0000; color: #fff;">
                                               <td> {{$item->sigla}} </td>
                                                <td> 
                            ...
                            <div class="table-flip-scroll">
                                ...
                                <table class="table table-striped table-bordered table-hover flip-content" id="tabela">
                                    ...
                                    <tbody>                                        
                                        ...
                                        @foreach ($ofSupAtivaMarinha as $item)     
                                            ...
                                            @endforeach
                                            @foreach ($ofSupReservaPttcMarinha as $item)     
                                            ...
                                            @foreach ($ofSupReservaMARINHAR1 as $item)     
                                            ...
                                            @foreach ($ofSupAtivaMarinhaPET as $item)     
                                            <tr style="background-color: #9b0000; color: #fff;">
                                               <td> {{$item->sigla}}  </td>
                                                <td> 
                                            ...
                                            @endforeach
                                             ...
                                             @foreach ($ofSupReservaMARINHAPETPTTC as $item)     
                                            <tr style="background-color: #9b0000; color: #fff;">
                                               <td> {{$item->sigla}} PTTC </td>
                                                <td> 
                                            ...
                                            @endforeach
                                            @foreach ($ofSupReservaMARINHAPET as $item)     
                                            <tr style="background-color: #9b0000; color: #fff;">
                                               <td> {{$item->sigla}}  </td>
                                                <td> 
