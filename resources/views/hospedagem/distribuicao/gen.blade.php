        ...
        <div class="title-block">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <small>Lista de Oficiais Generais </small> 
                </div>
            </div>
        </div>
                    ...
                    <div class="card-block">
                        <section class="example">
                            <div class="table-flip-scroll">
                                  <h3 class="title"> Oficiais Generais </h3>
                                 <hr>
                             <table class="table table-striped table-bordered table-hover flip-content" id="tabela">
                                    ...
                                    <tbody>                                        
                                            ...
                                            @foreach ($genReservaPttc as $item) 
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-block">
                        <section class="example">
                            <div class="table-flip-scroll">
                                <h3 class="title"> Pensionistas de Generais </h3>
                                 <hr>
                             <table class="table table-striped table-bordered table-hover flip-content" id="tabela">
                                    <thead class="flip-header">
                                        <tr>
                                    ...
                                    <tbody>                                        
                                            ...
                                            @foreach ($genPensionista as $item) 
