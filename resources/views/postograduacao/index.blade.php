...
<article class="items-list-page">
    <div class="title-search-block">
        <div class="title-block">
            <div class="row">
                <div class="col-md-6">
                     <h3 class="title"> Selecione a Força </h3>
                    <small>Gerenciar Posto / Graduação </small>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-block">
                     ...
                     <a href="{{ route('postograduacao.list', ['id' => Crypt::encrypt($item->id)]) }}" title="Visualizar" class="btn btn-info btn-sm">
