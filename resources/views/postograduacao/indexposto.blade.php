    ...
    <div class="title-search-block">
        <div class="title-block">
            <div class="row">
                {{$consulta}}
                <div class="col-md-6">
                    <h3 class="title"> Lista de Posto / Graduação <a href="{{ route('postograduacao.create.show',  ['id' => Crypt::encrypt($forca->id)]) }}" class="btn btn-primary btn-sm rounded-s"> Add </a></h3>
                    <small>  {{$forca->forca}}</small> 
                </div>
            </div>
        </div>
    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                ...
                <a href="{{ route('postograduacao.edit', ['id' => Crypt::encrypt($item->id)]) }}" title="Editar Área" class="btn btn-info btn-sm">
                                        ...
                                        <form action="" id="deletearea" method="get">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    {{ csrf_field() }}  
                                                    {{ method_field('DELETE') }}
                                                    <p>Tem certeza que deseja deletar esse Posto / Graduação ?</p>
                                                </div>
...
<script type="text/javascript">
     ...
     {
         var id = id;
         var url = '{{ route("postograduacao.destroy", ":id") }}';
