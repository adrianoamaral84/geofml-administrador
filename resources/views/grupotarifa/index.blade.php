...
<article class="items-list-page">
    <div class="title-search-block">
        <div class="title-block">
            <div class="row">
                <div class="col-md-6">
                    <h3 class="title"> Grupo Tarifas  <a href="{{ route('grupo_tarifa.create')}}" class="btn btn-primary btn-sm rounded-s"> Add </a></h3> 
                </div>
            </div>
        </div>
                            ...
                            <div class="table-flip-scroll">
                                <table class="table table-striped table-bordered table-hover flip-content">
                                    ...
                                    <tbody>                                        
                                            ...
                                            <td>{{$item->tipoundhabitacao->descricao}}</td>
                                                <td>{{$item->descricao}}</td>
                                                <td style="text-align: center;">
                                                    <h6>
                                                    

                <a href="{{ route('grupo_tarifa.edit', ['id' => Crypt::encrypt($item->id)]) }}" class="btn btn-info btn-sm">
...
<script type="text/javascript">
     ...
     {
         var id = id;
         var url = '{{ route("grupo_tarifa.delete", ":id") }}';
