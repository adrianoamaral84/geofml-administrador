...
<article class="items-list-page">
    <div class="title-search-block">
        <div class="title-block">
            <div class="row">
                <div class="col-md-6">
                    <h3 class="title"> Temporadas  <a href="{{ route('temporada.create')}}" class="btn btn-primary btn-sm rounded-s"> Add </a></h3> 
                    <small>Cadastra os períodos da alta e baixa temporada</small>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
     ...
     {
         var id = id;
         var url = '{{ route("temporada.delete", ":id") }}';
