...
<article class="items-list-page">
    <div class="title-search-block">
        <div class="title-block">
            <div class="row">
                <div class="col-md-6">
                    <h3 class="title"> Unidades Habitacionais  <a href="{{ route('uh.create')}}" class="btn btn-primary btn-sm rounded-s"> Add </a></h3> 
                </div>
            </div>
        </div>
                                ...
                                <table class="table table-striped table-bordered table-hover flip-content" id="tabela">
                                    <thead class="flip-header">
                                        <tr>
                                            ...
                                            <th width="5%">Capacidade</th>
                                            <th width="5%" style="text-align: center;">Classe</th>
                                            <th width="55s%">Destino</th>                
                                    ...
                                    <tbody>                                        
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$item->sigla}}</td>
                                                <td>{{$item->tipohabitacao->descricao}}</td>
                                                <td style="text-align: center;">{{$item->capacidade_ocupacao }}</td>
                                                <td style="text-align: center;">{{$item->classe->classe}}</td>
                                                 <td>{{$item->destino->descricao}}</td>
                                                <td style="text-align: center;">
                                                   
                                                    

                <a href="{{ route('uh.edit', ['id' => Crypt::encrypt($item->id)]) }}" class="btn btn-info btn-sm">
...
<script type="text/javascript">
    ...
    buttons: [
            ...
            {
                extend: 'excelHtml5',              
                title: 'GEOFML - Unidades Habitacionais'
            },
            {
                extend: 'pdfHtml5',
                title: 'GEOFML - Unidades Habitacionais'
