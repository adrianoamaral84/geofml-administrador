...
<article class="items-list-page">
    <div class="title-search-block">
        <div class="title-block">
            <div class="row">
                <div class="col-md-6">
                    <h3 class="title"> Lista de Força  <a href="{{Route('forca.create')}}" class="btn btn-primary btn-sm rounded-s"> Add Força </a></h3> 
                </div>
            </div>
        </div>
    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                ...
                <a href="{{ route('forca.edit', ['id' => Crypt::encrypt($item->id)]) }}" class="btn btn-info btn-sm">
                    <i class="fas fa-edit" style="color: #ffffff"></i></a>

                     <a href="{{ route('forca.index', ['id' => Crypt::encrypt($item->id)]) }}" title="Mostrar" class="btn btn-info btn-sm">
                                        ...
                                        <form action="" id="deletearea" method="get">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    {{ csrf_field() }}  
                                                    {{ method_field('DELETE') }}
                                                    <p>Tem certeza que deseja deletar esta Força ?</p>
                                                </div>
