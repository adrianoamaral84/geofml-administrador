...
<article class="items-list-page">
    <div class="title-search-block">
        <div class="title-block">
            <div class="row">
                <div class="col-md-6">
                    <h3 class="title"> Gerenciador de E-mails </h3> 
                    <small>Gerencia todos os e-mails enviados pelo sistema!</small>
                </div>
            </div>
        </div>
                                ...
                                <table class="table table-striped table-bordered table-hover flip-content">
                                    <thead class="flip-header">
                                        <tr>
                                            ...
                                            <th width="20%" style="text-align: center;">Assunto</th>
                                            <th width="20%" style="text-align: center;">Cabeçalho</th>
                                            <th width="55%" style="text-align: center;">Corpo</th>
                                    ...
                                    <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="vertical-align: middle; text-align: center;">
                                                        ...
                                                        <a href="{{ route('email.editar', ['id' => Crypt::encrypt($item->id)]) }}" class="btn btn-secondary btn-sm"><i class="fas fa-edit"></i></a>
...
<article class="items-list-page">
    <div class="title-search-block">
        <div class="title-block">
            <div class="row">
                <div class="col-md-6">
                    <h3 class="title"> Assinatura </h3> 
                    <small>Configura as assinaturas dos emails!</small>
                </div>
            </div>
        </div>
        <div class="items-search">
                                ...
                                <table class="table table-striped table-bordered table-hover flip-content">
                                    <thead class="flip-header">
                                        <tr>
                                            ...
                                            <th width="">Nome de Guerra</th>
                                            <th width="">Posto / Graduação</th>       
                                            <th width="15%" style="text-align: center;">Ação</th>

                                        </tr>
                                    </thead>
                                    <tbody>                                        
                                            @if ($assinatura->count() == 0)
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td> {{ $item->nome }} </td>
                                        <td>{{ $item->posto->sigla }}</td>
                                                <td style="text-align: center;">
                                                    <h6>
                                                    

                <a href="{{ route('assinatura.edit', ['id' => Crypt::encrypt($item->id)]) }}" class="btn btn-info btn-sm">
