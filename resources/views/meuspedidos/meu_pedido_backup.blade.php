                ...
                <form id="profile-form" action="{{ route('hospede.uploadrecibo')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div>
                                <div class="alert alert-info" role="alert">
                                    <div align="center" class="card-content">
                                       Faça o upload do comprovante de pagamento para o sistema!!
                                    </div>
                                </div>
                            </div>
                        @endif
                    ...
                    <div class="row has-error">
                       ...
                       @if($hospedagem->status == 0)
                        ...
                        <div class="form-group col-sm-12 col-md-3 col-lg-3">
                          ...
                          <label class="control-label">{{ __('Unidade Habitacional') }}</label>
                        ...
                        @if($hospedagem->status == 2)
                         ...
                         <div class="form-group col-sm-12 col-md-3 col-lg-3">                  
                            ...
                            <input type="text" class="form-control boxed @error('valor') is-invalid @enderror" value="{{ number_format( $valorPagarRestante, 2, ',', '.' )}}" name="valorrestante" id="valorrestante" required autofocus readonly onpaste="return false;">
                            @error('valor')
                                <span class="has-error" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                      ...
                      @if($hospedagem->status == 2)
                          @role('atendente|administrador_geral|administrador')
                              ...
                              <div class="row has-error">
                               @if($hospedagem->checkin == 1)
                                ...
                                @if($hospedagem->checkin == 2)
                                <div class="form-group col-sm-12 col-md-3 col-lg-3">  
                                <label class="control-label">{{ __('Data Check-Out') }}</label>
                                <input type="text" class="form-control boxed @error('datacheckout') is-invalid @enderror" value="{{ \Carbon\Carbon::parse($hoje)->format('d-m-Y H:i:s') }}" name="datacheckout" id="datacheckout" required readonly autofocus onpaste="return false;">
                                @error('datacheckout')
                                <span class="has-error" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                 ...
                 <div class="row has-error">
                    ...
                    <div class="form-group col-sm-12 col-md-6 col-lg-6">
                            ...
                            <p class="title-description"> Comprovante de Pagamento no formato .jpg .png ou <font style="color: red;"> print </font>( máximo 2MB )</p>
                            @error('documento')
                                <span class="has-error" role="alert">
                                <strong>{{ $message }}</strong>
                                </span>
                      ...
                      @endif
                        ...
                        @if($hospedagem->status == 4)
                         <div class="form-group col-sm-12 col-md-6 col-lg-6">
                            ...
                            <a href="data:image/png;base64, {{ $arquivo }}" target="_blank" title="Ver Comprovante de Pagamento" class="btn btn-secondary btn-xl" style="margin-top: 20px;"><i class="fas fa-address-card"></i>
              ...
              <div class="row has-error">
                    <div class="form-group col-sm-12 col-md-12 col-lg-12">
                            ...
                            -->
                                    ...
                                    @role('atendente|administrador_geral')
