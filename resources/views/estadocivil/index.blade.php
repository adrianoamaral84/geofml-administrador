...
<article class="items-list-page">
    <div class="title-search-block">
        <div class="title-block">
            <div class="row">
                <div class="col-md-6">
                    <h3 class="title"> Lista de Estado Civil  <a href="{{Route('estadocivil.create.show')}}" class="btn btn-primary btn-sm rounded-s"> Add Estado Civil </a></h3> 
                </div>
            </div>
        </div>
        <div class="items-search">
            <form class="form-inline" method="POST" action="{{Route('estadocivil.index')}}">
            @csrf       
    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                ...
                <a href="{{ route('estadocivil.edit', ['id' => Crypt::encrypt($item->id)]) }}" class="btn btn-info btn-sm">
                                        ...
                                        <form action="" id="deletearea" method="get">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    {{ csrf_field() }}  
                                                    {{ method_field('DELETE') }}
                                                    <p>Tem certeza que deseja deletar este Estado civil ?</p>
                                                </div>
...
<script type="text/javascript">
     ...
     {
         var id = id;
         var url = '{{ route("estadocivil.destroy", ":id") }}';
