...
<article class="items-list-page">
    ...
    @endif
@if(\Laratrust::hasRole('administrador_geral') || \Laratrust::hasRole('administrador_especial') || \Laratrust::hasRole('administrador') || \Laratrust::hasRole('auxiliar_administrador_geral'))
