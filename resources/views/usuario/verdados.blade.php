                ...
                <form id="profile-form" action="{{ route('atualiza.dados.usuario') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row has-error">
                        ...
                        <div class="form-group col-sm-4 col-md-4 col-lg-4">
                            ...
                            <input type="text" class="form-control boxed @error('cpf') is-invalid @enderror" value="{{ $user->cpf }}" name="cpf" id="cpf" required autofocus maxlength="11" data-mask="000.000.000-00" readonly="" onpaste="return false;">
                            @error('cpf')
                                <span class="has-error" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="form-group row">
                        <div class="col-sm-12 col-xl-12">
                            ...
                            * Resetar a senha para o CPF cadastrado!
                             </p><br> @role('administrador_geral|auxiliar_administrador_geral')
