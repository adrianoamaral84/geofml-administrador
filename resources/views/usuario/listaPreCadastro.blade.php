...
<article class="items-list-page">
    <div class="title-search-block">
        <div class="title-block">
            <div class="row">
                <div class="col-md-6">
                    <h3 class="title"> Usuários no Pré Cadastro @role('administrador_geral')<a href="{{route('usuario.novo')}}" class="btn btn-primary btn-sm rounded-s"> Add Novo </a>@endrole</h3>
                </div>
            </div>
        </div>
        <div class="items-search">
           
       <!-- <form method="GET" action="{{ route('precadastro') }}" class="form-inline">
    <div class="input-group input-group-sm">
        ...
        @if(request('search'))
            <div class="input-group-append ml-2">
                <a href="{{ route('precadastro') }}" class="btn btn-secondary btn-sm">Limpar</a>
            </div>
        @endif
    </div>
</form> -->
                        ...
                        <section class="example">
                            <div class="table-flip-scroll">
                                    ...
                                    <tbody>
                                        ...
                                        @else   
                                            ...
                                            <tr>
                                                ...
                                                <td> <a href="{{route('usuario.verdados', ['id' => Crypt::encrypt($item->id)])}}" data-toggle="tooltip" data-placement="bottom" title="Ver Dados">{{$item->name}}</a></td>
                                                ...
                                                <td style="text-align: center;">
                                                    ...
                                                    <a href="{{route('usuario.verdados', ['id' => Crypt::encrypt($item->id)])}}" data-toggle="tooltip" data-placement="bottom" title="Ver Dados"><i class="far fa-eye fa-md" style="color: blue;"></i></a>
                                                     ...
                                                     <a href="javascript:;" data-toggle="modal" onclick="deleteUsuario('{{ Crypt::encrypt($item->id) }}')" data-target="#DeleteUsuarioModal"  title="Deletar">
                                                    <i class="fas fa-regular fa-trash" style="color: red;"></i></a>
                               ...
                               <div class="modal fade" id="DeleteModal">
                                ...
                                <div class="modal fade" id="DeleteUsuarioModal">
                                    <div class="modal-dialog" role="document">
                                        <form action="" id="deleteUsuario" method="get">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h4 class="modal-title"><i class="fa fa-warning"></i> Atenção</h4>
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                ...
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-primary" data-dismiss="modal" onclick="formSubmitDelete()">Sim</button>
                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Não</button>
                                                </div>
                                            </div>
                                        </form>
