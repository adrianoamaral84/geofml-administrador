                ...
                <form id="profile-form" action="{{ route('atualiza.dados.usuario') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row has-error">
                        ...
                        <div class="col-sm-4 col-md-4 col-lg-4 form-group identidade">
                            ...
                            <input type="text" class="form-control boxed @error('idtMil') is-invalid @enderror" value="@if($user->idtMil){{$user->idtMil}}@endif" name="idtMil" id="idtMil" maxlength="9" required="required" autocomplete="off" onpaste="return false;">
                            @error('idtMil')
                                <span class="has-error" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                     ...
                     <div class="row form-group has-error">
                        <div class="col-3 form-group">
                           @if($user->documento) 
                                ...
                                <a href="data:image/png;base64, {{ $user->documento }}" target="_blank" class="btn btn-secondary btn-xl rounded-s"><i class="fas fa-address-card"></i>
                                 Frente
                            </a>     
                            @endif
                        </div>
                          <div class="col-3 form-group">
                             @if($user->documento_verso)   
                                ...
                                <a href="data:image/png;base64, {{ $user->documento_verso }}" target="_blank" target="_blank" class="btn btn-secondary btn-xl"><i class="fas fa-address-card"></i>
                                Verso
                            </a>   
