            ...
            <div class="card card-block sameheight-item">
                ...
                <div class="row has-error">
                    ...
                    <div class="row form-group has-error">
                        ...
                        <input type="file" class="custom-file-input" name="documento" id="documento" accept=".jpg,.png,.pdf" @if(!$user->documento) required="" @endif>
                        ...
                        <div class="custom-file">
                         ...
                         <input type="file" class="custom-file-input" name="documento_verso" id="documento_verso" accept=".jpg,.png,.pdf" @if(!$user->documento_verso) required="" @endif>
                            <label class="custom-file-label" for="customFile">Escolha o arquivo</label>
...
@push('javascript')
    ...
    <script>  
        ...
        function NewTab() {
        window.open("data:image/png;base64, {{ $user->documento }}", "_blank");
        }
