...
<article class="items-list-page">
    <div class="title-search-block">
        <div class="title-block">
            <div class="row">
                <div class="col-md-6">
                    <h3 class="title"> Usuários Inativos @role('administrador_geral')<a href="{{route('usuario.novo')}}" class="btn btn-primary btn-sm rounded-s"> Add Novo </a>@endrole</h3>
                </div>
            </div>
        </div> 
                                    ...
                                    <tbody>
                                        ...
                                        @else   
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center;">@if(@isset($item->motivoinativos->motivo)) {{ $item->motivoinativos->motivo }} @endif</td>
