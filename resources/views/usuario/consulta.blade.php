...
<article class="items-list-page">
    <div class="title-search-block">
        <div class="title-block">
            <div class="row">
                <div class="col-md-6">
                    <h3 class="title"> Usuários do Sistema @role('administrador_geral')<a href="{{route('usuario.novo')}}" class="btn btn-primary btn-sm rounded-s"> Add Novo </a>@endrole</h3>
                </div>
            </div>
        </div>
                ...
                <div class="input-group">
                    ...
                    @if(request('pesquisa'))
                        <div class="input-group-append ml-2">
                            <a href="{{ route('user.index') }}" class="btn btn-secondary">Limpar</a>
                        </div>
                    @endif
                </div>
            </form> -->
...
<form method="GET" action="{{ route('user.index') }}" class="form-inline">
    <div class="input-group input-group-sm"> <input type="text" 
        ...
        <div class="input-group-append">
            <button type="submit" class="btn btn-primary btn-sm">Buscar</button> </div>
        @if(request('pesquisa'))
            <div class="input-group-append ml-2">
                <a href="{{ route('user.index') }}" class="btn btn-secondary btn-sm">Limpar</a> </div>
        @endif
    </div>
</form>
...
<script type="text/javascript">
    ...
    lengthChange: false,
    searching: false, // <-- INSERIR AQUI, NO BLOCO PRINCIPAL
    lengthMenu: [
            [ 10, 25, 50, -1 ],
