...
<article class="items-list-page">
    <div class="title-search-block">
        <div class="title-block">
            <div class="row">
                <div class="col-md-6">
                    <h3 class="title"> Lista de Tipo Documento Militar  <a href="{{Route('documentomilitar.create.show')}}" class="btn btn-primary btn-sm rounded-s"> Add </a></h3> 
                </div>
            </div>
        </div>
        <div class="items-search">
            <form class="form-inline" method="POST" action="{{Route('documentomilitar.index')}}">
            @csrf       
    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                ...
                <a href="{{ route('documentomilitar.edit', ['id' => Crypt::encrypt($item->id)]) }}" class="btn btn-info btn-sm">
...
<script type="text/javascript">
     ...
     {
         var id = id;
         var url = '{{ route("documentomilitar.destroy", ":id") }}';
