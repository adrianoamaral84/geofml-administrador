                        ...
                        <div class="form-group col-sm-12 col-md-12 col-lg-6">
                            ...
                            @enderror
                             ...
                             <div class="row form-group has-error">
                                        ...
                                        <div class="form-group col-sm-12 col-md-12 col-lg-6 dataini">
                                            ...
                                            <input type="text" name="dataini" id="dataini" class="form-control boxed" value="{{ old('dataini') }}" maxlength="50" minlength="2" onpaste="return false;" required="" autofocus>
                            ...
                            @enderror 
                                           ...
                                           <div class="form-group col-sm-12 col-md-12 col-lg-6 datater">
                                            ...
                                            <input type="text" name="datater" id="datater" class="form-control boxed" value="{{ old('datater') }}" maxlength="50" minlength="2" onpaste="return false;" required="" autofocus>
                                            @error('datater')
                                <span class="has-error" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
