...
<article class="items-list-page">
    <div class="title-search-block">
        <div class="title-block">
            <div class="row">
                <div class="col-md-6">
                    <h3 class="title"> Lista de Reservas para Check-Out</h3> 
                    <small>Lista de hospedes aprovados para realizar o check-out da UH!</small>
                </div>
            </div>
        </div>
        <div class="items-search">
           
<form method="GET" action="{{ url('atendente/checkout') }}" class="form-inline mb-3">
    <div class="input-group input-group-sm">
        ...
        @if(request('search'))
            <div class="input-group-append ml-2">
                <a href="{{ url('atendente/checkout') }}" class="btn btn-secondary btn-sm">Limpar</a>
            </div>
        @endif
    </div>
</form>
