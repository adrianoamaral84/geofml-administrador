...
<form method="GET" action="{{ route('lista.pedidos') }}" class="form-inline">
    <div class="input-group input-group-sm">
        ...
        @if(request('search'))
            <div class="input-group-append ml-2">
                <a href="{{ route('lista.pedidos') }}" class="btn btn-secondary btn-sm">Limpar</a>
            </div>
        @endif
    </div>
</form>
                        ...
                        <section class="example">
                            <div class="table-flip-scroll">
                                <table class="table table-striped table-bordered table-hover flip-content" id="tabela">
                                    ...
                                    <a href="javascript:;" data-toggle="modal" onclick="deleteUsuario('{{ Crypt::encrypt($item->id) }}')" data-target="#DeleteUsuarioModal" class="btn btn-danger btn-sm" title="Deletar">
                                ...
                                <div class="modal fade" id="DeleteUsuarioModal">
                                    <div class="modal-dialog" role="document">
                                        <form action="" id="deleteUsuarios" method="get">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h4 class="modal-title"><i class="fa fa-warning"></i> Atenção</h4>
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
    ...
    function deleteUsuario(id)
     {
         ...
         $("#deleteUsuarios").attr('action', url);
     }


     function formSubmitDelete()
     {
         $("#deleteUsuarios").submit();
     }
