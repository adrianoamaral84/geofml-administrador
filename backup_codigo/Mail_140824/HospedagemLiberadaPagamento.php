...
class HospedagemLiberadaPagamento extends Mailable
{
    ...
    {
        $this->subject('Hospedagem Liberada para Pagamento!');
        ...
        return $this->markdown('mail.hospedagemLiberadaPagamento')->with([
